...
<body>
    <?php 
        if(isset($_GET['id']) && !empty($_GET['id'])){
            ...
            $recup = $bdd->prepare("SELECT * FROM films WHERE idFilm = ?");
            $recup->execute(array($id));

            if($recup->rowCount()>0){
                $infoFilm = $recup->fetch();
                
                $titre = $infoFilm['nomFilm'];
                $resume = $infoFilm['resumeFilm'];
                $image = $infoFilm['imageFilm'];
                $duree = $infoFilm['dureeFilm'];
            }
        }
    ?>
    <div class="main">
            ...
            <div class="infos_contenu">
                ...
                <div class="boutons">
                    <button><a href="">
                        ...
                        Continuer</a></button>
                    <button><a href="Ajoutfavoris.php">
