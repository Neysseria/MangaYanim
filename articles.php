      ...
      <div class="row">
        <div class="col-md-12">
          <div class="content-panel">
            <h4><i class="fa fa-angle-right"></i> Articles</h4>
            <hr>
            <!-- <h2>Ajouter un article</h2>
                ...
                ?>
            <button class="ajout"><a href='ajouterarticles.php'> + Ajouter un article</a></button> 
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <?php 
                    ...
                    $articles=$recup->fetchAll();
                    foreach($articles as $article):
                ?>
                    <tr>
                        <td><?= $article["idArticle"]?></td>
                        <td><?= $article["titreArticle"]?></td>
                        <td class="tdcontenu"><?= $article["contenuArticle"]?></td>
                        <td><?= $article["imageArticle"]?></td>
                        <td></td>
                        <td class="changement"><a href="articlesmodifie.php?id=<?= $article["idArticle"]?>">
                        ...
                        modifier</a></td>
                        <td class="changement"><a href="articlessupprime.php?id=<?= $article["idArticle"]?>">
