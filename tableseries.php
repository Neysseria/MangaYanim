<?php
  ...
  $select = $bdd->prepare("SELECT * FROM series");
  $select->execute();
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="content-panel">
            <h4><i class="fa fa-angle-right"></i> Series</h4>
            <hr>
                ...
                ?>
            <button class="ajout"><a href='tableseriesajout.php'> + Ajouter une série</a></button> 
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <?php 
                    $recup=$bdd->query("SELECT * FROM series");
                    $series=$recup->fetchAll();
                    foreach($series as $serie):
                ?>
                    <tr>
                        <td><?= $serie["idSeries"]?></td>
                        <td><?= $serie["nomSerie"]?></td>
                        <td class="tdcontenu"><?= $serie["resumeSerie"]?></td>
                        <td><?= $serie["dureeSerie"]?></td>
                        <td></td>
                       <td class="changement"><a href="tableseriesmodif.php?id=<?= $serie["idSeries"]?>"> modifier</a></td>
                      <td class="changement"><a href="tableseriessup.php?id=<?= $serie["idSeries"]?>">supprimer</a></td> 
